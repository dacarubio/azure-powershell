#
# Module manifest for module 'Az.DeviceProvisioningServices'
#
...
Description = 'Microsoft Azure PowerShell - IoT Device Provisioning Service cmdlets for Azure Resource Manager in Windows PowerShell and PowerShell Core.

For more information on IoT Device Provisioning Service, please visit the following: https://docs.microsoft.com/azure/iot-dps/'
...
RequiredAssemblies = 'Microsoft.Azure.Management.DeviceProvisioningServices.dll', 
               ...
               'Microsoft.Azure.Devices.Provisioning.Service.dll'
...
CmdletsToExport = 'New-AzIoTDeviceProvisioningService', 
...
AliasesToExport = 'New-AzIoTDps', 'Get-AzIoTDps', 'Remove-AzIoTDps', 'Update-AzIoTDps', 
               'Get-AzIoTDpsAccessPolicy', 'Add-AzIoTDpsAccessPolicy', 
               'Remove-AzIoTDpsAccessPolicy', 'Update-AzIoTDpsAccessPolicy', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Allowed update of attestation information (e.g. keys, certificates) for exsting device enrollments and enrollment groups'
