...
FunctionsToExport = 'Get-AzDedicatedHsm', 'New-AzDedicatedHsm', 'Remove-AzDedicatedHsm', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Fixed an issue that may cause ''New-AzDedicatedHsm'' to return before the HSM is fully provisioned (https://github.com/Azure/autorest.powershell/issues/610)'
