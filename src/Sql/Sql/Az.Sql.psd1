...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated ''Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline'' documentation to include example of define array of array with one inner array.
