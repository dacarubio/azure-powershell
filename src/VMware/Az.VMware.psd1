...
FunctionsToExport = 'Get-AzVMwareAuthorization', 'Get-AzVMwareCluster', 
               'Get-AzVMwarePrivateCloud', 
               'Get-AzVMwarePrivateCloudAdminCredentials', 
               'New-AzVMwareAuthorization', 'New-AzVMwareCluster', 
               'New-AzVMwarePrivateCloud', 'Remove-AzVMwareAuthorization', 
               'Remove-AzVMwareCluster', 'Remove-AzVMwarePrivateCloud', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* [BreakingChange] Renamed module to Az.VMware
