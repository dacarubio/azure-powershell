...
CmdletsToExport = 'Get-AzDataBoxEdgeJob', 'Get-AzDataBoxEdgeDevice', 
               ...
               'Invoke-AzDataBoxEdgeShare', 'Get-AzDataBoxEdgeBandwidthSchedule', 
               ...
               'Remove-AzDataBoxEdgeOrder', 'Get-AzDataBoxEdgeStorageAccount', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added cmdlet ''Get-AzDataBoxEdgeStorageContainer''
