...
CmdletsToExport = 'New-AzFrontDoor', 'Get-AzFrontDoor', 'Set-AzFrontDoor', 
               ...
               'Get-AzFrontDoorRulesEngine', 'Set-AzFrontDoorRulesEngine', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Allowed Enable-AzFrontDoorCustomDomainHttps''s SecretVersion parameter to be optional to support bring-your-own-certificate auto-rotation'
